...
?>
    <fieldset id="pt1" <?php echo (empty($one) ? '':'class="error"')?>>
        ...
        <?php echo $form->input('Install.server', array('id' => 'server', 'label' => false, 'tabindex' => '1'))?>
        <label for="login">Username</label>
        <?php echo $form->input('Install.login', array('id' => 'login','label' => false, 'tabindex' => '2'))?>
        <label for="password">Password</label>
        <?php echo $form->input('Install.password', array('id' => 'password','type' => 'password','label' => false, 'tabindex' => '3'))?>
    </fieldset>
    <fieldset id="pt2" <?php echo (empty($two) ? '':'class="error"')?>>
        ...
        <?php echo $form->input('Install.database', array('id' => 'database','label' => false, 'tabindex' => '4'))?>
        <label for="prefix">Prefix</label>
        <?php echo $form->input('Install.prefix', array('id' => 'prefix','label' => false, 'tabindex' => '5'))?>
    </fieldset>
    <fieldset id="pt3" <?php echo (empty($three) ? '':'class="error"')?>>
        ...
        <?php echo $form->input('Install.user', array('id' => 'user','label' => false, 'tabindex' => '6'))?>
        <label for="password">Password</label>
        <?php echo $form->input('Install.pass', array('id' => 'pass','label' => false, 'tabindex' => '7', 'type' => 'password'))?>
    </fieldset>
    <fieldset id="pt4" >
