...
$LastChangedDate: 2005-07-03 10:57:30 +0200 (So, 03 Jul 2005) $
...
Sayfayı açmak için linki tıklayın
_P;
...
İkinci alternatif renk (satır için), uzun listeler için.
_P;

$tsep_lng['config_dir_exclude'] = <<<_P
Dahil edilmeyen dizinleri girin:
_P;

$tsep_lng['config_ext_include'] = <<<_P
İçerilecek dosya uzantıları
_P;

$tsep_lng['config_ext_include_help'] = <<<_P
İndeksleyici sadece burda uzantıları verilen dosyaları indeksler(kelimeler arasında virgül kullanın ör.:HTM,HTML,PHP
_P;

$tsep_lng['config_file_exclude'] = <<<_P
Dahil edilmeyecek dosyaları girin:
_P;
...
sunucu ve local arasındaki saat farkı. Buna göre ayarla
_P;

$tsep_lng['config_max_exec_time'] = <<<_P
İndeksleyicinin çalışacağı maksimum süre (dakika olarak)
_P;
...
Bu alan dahili notlar için kullanılabilir. Bu alan için sadece adminler görebilir !
_P;

$tsep_lng['config_Language'] = <<<_P
TSEP'i hangi dilde kullanmak istiyorsunuz? Örnek: İngilizce için 'en', Almanca için 'de' yi seçin
_P;

$tsep_lng['config_listFilenamesOnly_help'] = <<<_P
İndeksleyici indeks oluşturmaz, sadece bütün dosyaları listeler,hangileri indexlenmeliyse.<br>Ek olarak, atlanacak dosya ve klasörler listelenir.
_P;

$tsep_lng['config_Logging_IP'] = <<<_P
IP adres kayıtlansın mı?
_P;

$tsep_lng['config_Logging_result_links'] = <<<_P
Arama sonuçlarındaki tıklamalar kayıtlansın mı?
_P;

$tsep_lng['config_Pagerank_Number'] = <<<_P
Arama düzeyini göstermek istiyormusunuz ?
_P;

$tsep_lng['config_parmsExternalPhp'] = <<<_P
datasupply-script 'e gönderilecek verileri girin:
_P;

$tsep_lng['config_Path'] = <<<_P
TSEP dizinini belirle. Örnek: eğer search.php'nin bulunduğu konum www.yourdomain.com/php/tsearch/search.php şeklinde ise, 'php/tsepsearch'
_P;

$tsep_lng['config_searchViaExt'] = <<<_P
indeksleyici datasupplier-script'i çalıştırmalı
_P;

$tsep_lng['config_searchViaRead'] = <<<_P
indeksleyici dosyaları dizinleri arayarak bulmalı
_P;

$tsep_lng['config_Show_Record_Change'] = <<<_P
Kullanıcı sayfa başına düşen sonuçları değiştirebilmeli mi ?
_P;

$tsep_lng['config_Use_Debug_Print'] = <<<_P
sadece programcılar için:debugprint() fonksiyonunu kullan ?(normal TSEP kullanıcıları için kapalı omalı) 
_P;
...
lütfen devam etmeden önce, bu hatayı DÜZELTİN!
_P;
...
Indexten bu sayfayı silmek istediğinizden eminmisinz ? (veritabanından bu sayfayla ilgili herşeyi sil)?
_P;
...
İndeklenmede saklanan veriyi düzenle
_P;

$tsep_lng['index_edit_title'] = <<<_P
İndeks Düzenleme(ayrıntılı)
_P;
...
Sayfanın ayrıntılarını düzenlemek için tıklayın
_P;

$tsep_lng['index_overview_click_url'] = <<<_P
Sayfayı web tarayıcınızda göstermek için tıklayın.
_P;

$tsep_lng['index_overview_head'] = <<<_P
Girdinin ayrıntıları için sayfa başlığını veya URL'yi tıklayın 
_P;

$tsep_lng['index_overview_title'] = <<<_P
İndeks Gözdengeçirme(kısa)
_P;

$tsep_lng['indexed_words'] = <<<_P
Bütün indeksi görüntüle(çok büyük olabilir!)
_P;
...
Lütfen arama için 4 veya daha fazla karakter girin.
_P;
...
Yeni bir index oluşturuldu!<br/>İndekslenmiş dosyalar
_P;

$tsep_lng['new_index_head_searching'] = <<<_P
Yeni indeks oluşturuluyor...<br/>Lütfen sabırlı olun
_P;
...
Bilgi bankasına (ESKİDEN) kayıtlanmış dosyaların listesi aşağıdadır.
_P;
...
Aramanız sonucunda bulunan kelimeler sayfada şu sıklıkta bulunmuş
_P;
...
sayfalar indekslenemedi
_P;

$tsep_lng['pages_to_be_indexed'] = <<<_P
indekslenecek sayfalar
_P;
...
en az birini içeren sayfaları bul.
_P;

$tsep_lng['search_tips_ex2'] = <<<_P
İkisinide içeren sayfaları bul.
_P;

$tsep_lng['search_tips_ex4'] = <<<_P
Kelime "elma" fakat "macintosh" hariç.
_P;

$tsep_lng['search_tips_head'] = <<<_P
TSEP'i daha etkili kullanmak için ip ucları
_P;

$tsep_lng['search_tips_help'] = <<<_P
yardımı yeni pencerede açar
_P;
...
İndeklenecek dosyalar.<br /> İndekslenecek dosyaların listesi
_P;

$tsep_lng['sim_index_head_searching'] = <<<_P
Dosyalar aranıyor...<br />Lütfen bekleyin...
_P;

$tsep_lng['sort_asc'] = <<<_P
A -> Z 'ye sıralar, en eski -> en yeni
_P;

$tsep_lng['sort_desc'] = <<<_P
Z -> A 'ya sıralar, en yeni -> en eski 
_P;
...
Önceden kullanılmış arama sorguları
_P;
...
Üzgünüm! Fikrim değişti. Devam edelim...
_P;

$tsep_lng['setup_ToPreviousStep'] = <<<_P
Önceki adıma geçelim
_P;
...
TSEP kurulumundan çıkmak istiyorum.
_P;
...
The TSEP root klasörü doğru değil.
_P;
...
Sayfanın ortasında bulunan "sonraki" butonuna tıklayınız.
_P;
...
Taze kurulum (genel değerler ile):
_P;

$tsep_lng['setup_Update'] = <<<_P
Eski sürümden güncelleme:
_P;

$tsep_lng['setup_CopyOld'] = <<<_P
Eski ayarları kopyala:
_P;
