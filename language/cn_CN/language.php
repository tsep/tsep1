...
用什么文字显示TSEP? 例如：英文选择‘en’，德文选择‘de’.
_P;
...
TSEP搜索引擎默认搜索所有词汇并显示所有含有搜索词汇的网页。搜索词汇的最小长度是四个字母。 下列是TSEP使用的布尔搜索例子:
_P;
...
搜索含有“苹果”的网页， 先显示也含有“香蕉”的网页。
_P;

$tsep_lng['search_tips_ex4'] = <<<_P
搜索含有“苹果”的网页， 不显示也含有“香蕉”的网页。
_P;

$tsep_lng['search_tips_ex5'] = <<<_P
"苹果"和"香蕉", 或者"苹果"和"西瓜"（任何顺序），"苹果香蕉"比"苹果西瓜"先排列。
_P;

$tsep_lng['search_tips_ex6'] = <<<_P
"苹果"、"苹果酱"、"苹果派"、"苹果馅饼"。 *代表0或者以上字符，必须出现在搜索词条之后。
_P;

$tsep_lng['search_tips_ex7'] = <<<_P
寻找含有丝毫不差"某词"的网页（例如，显示含有"她好用某词"的网页，而不显示含有"某些词"的网页）
_P;
