...
class htaccess{ 
    ...
    */ 
    function htaccess($htaccess, $htgroup, $fpasswd){ 
    	
    	$this->setFHtaccess($htaccess);
    	$this->setFHtgroup($htgroup);
    	$this->setFPasswd($fpasswd);
    } 
    ...
    */ 
    protected function setFHtaccess($filename){ 
    ...
    */ 
    protected function setFHtgroup($filename){ 
    ...
    * @param string    $filename    the name of htgroup file 
    */ 
    protected function setFPasswd($filename){ 
