...
osoitetut indeksointiprofiilit
_P;
...
Klikkaa tätä linkkiä avataksesi sivun
_P;
...
määritä TSEPin temp-hakemiston absoluuttinen polku
_P;

$tsep_lng['config_Color_1'] = <<<_P
Ensimmäinen vaihtuva väri (rivissä), pitkissä listauksissa
_P;

$tsep_lng['config_Color_2'] = <<<_P
Toinen vaihtuva väri (rivissä), pitkissä listauksissa
_P;

$tsep_lng['config_dir_exclude'] = <<<_P
Kirjoita hakemisto jotka jätetään pois indeksoinnissa.
_P;

$tsep_lng['config_ext_include'] = <<<_P
Tiedostotyypit jotka sisällytetään indeksointiin
_P;

$tsep_lng['config_ext_include_help'] = <<<_P
Indeksoija indeksoi vain tiedostot, joiden tiedostopäätteet on annettu tässä (pilkuilla erotettuina, esim. HTM,HTML,PHP)
_P;

$tsep_lng['config_file_exclude'] = <<<_P
Kirjoita tiedostot jotka jätetään huomioimatta indeksoinnissa:
_P;
...
tuntiero palvelimen kellonajan (server time) ja paikallisen kellonajan (local time) välillä. Säädä sen mukaisesti
_P;

$tsep_lng['config_How_Many_CharsAfter_Hit'] = <<<_P
Kuinka monta merkkiä näytetään ensimmäisen osuman jälkeen?
_P;

$tsep_lng['config_How_Many_CharsBefore_Hit'] = <<<_P
Kuinka monta merkkiä näytetään ennen ensimmäistä osumaa?
_P;

$tsep_lng['config_How_Many_Sentences'] = <<<_P
Kuinka monta hakulauseketta näytetään?
_P;
...
Haluatko loggausta ollenkaan?
_P;

$tsep_lng['config_Logging_IP'] = <<<_P
Logataanko IP-osoitteet?
_P;

$tsep_lng['config_Logging_result_links'] = <<<_P
Logataanko hakutulosten painallukset?
_P;

$tsep_lng['config_Logging_search_term'] = <<<_P
Logataanko hakusanat?
_P;

$tsep_lng['config_Numbers_Put'] = <<<_P
Näytetäänkö sivunumero osumalistauksessa?
_P;

$tsep_lng['config_Numbers_Put_After'] = <<<_P
Jos näytämme sivunumerot osumalistauksessa, näytä tämä numeron jälkeen
_P;

$tsep_lng['config_Numbers_Put_Before'] = <<<_P
Jos näytämme sivunumerot osumalistauksessa, näytä tämä ennen numeroa
_P;

$tsep_lng['config_Pagerank_Number'] = <<<_P
Haluatko näyttää hakurankingin?
_P;

$tsep_lng['config_parmsExternalPhp'] = <<<_P
Anna arvo joka lähetetään tiedontoimitus (datasupply)-skriptiin:
_P;
...
KORJAA tämä virhe ENNEN jatkamista!
_P;

$tsep_lng['error_from_extscript'] = <<<_P
<@>virhe(t), ulkoisen skriptin palautetut
_P;
...
Tämä aukaisee uuden ikkunan TSEPin Sourceforge.net -sivuilla.
_P;

$tsep_lng['help_del_indexedpage'] = <<<_P
Oletko varma että haluat tuhota tämän sivun indeksistä (poista kaikki tällä sivulla oleva tieto tietokannasta)?
_P;

$tsep_lng['help_del_maxresult'] = <<<_P
Oletko varma että haluat tuhota tämän maksimituloksen?
_P;

$tsep_lng['help_del_stopword'] = <<<_P
Oletko varma että haluat tuhota tämän kieltosanan?
_P;

$tsep_lng['help_first_page'] = <<<_P
mene ensimmäiselle sivulle
_P;
...
mahdotonta: nimi on jo olemassa
_P;

$tsep_lng['index_edit_date'] = <<<_P
<@>Viimeinen indexin korjaus:
_P;

$tsep_lng['index_edit_head'] = <<<_P
Muokkaa indeksiin varastoituta tietoa
_P;

$tsep_lng['index_edit_title'] = <<<_P
Indeksin muokkaus (yksityiskohtainen)
_P;
...
Viimeisin indeksointipäivämäärä
_P;
...
Klikkaa tänne muokataksesi sivun tietoja.
_P;

$tsep_lng['index_overview_click_url'] = <<<_P
Klikkaa tänne nähdäksesi sivun selaimessa.
_P;

$tsep_lng['index_overview_head'] = <<<_P
Klikkaa sivun otsikkoon tai webosoitteeseen (URL) avataksesi hakusanan tiedot.
_P;

$tsep_lng['index_overview_title'] = <<<_P
<@>Indexin yleiskatsaus (lyhyt)
_P;

$tsep_lng['indexed_words'] = <<<_P
Näytä nykyinen indeksi täydellisenä (indeksi voi olla hyvin laaja!)
_P;
...
Luo uutta indeksiä...<br />Pyydämme kärsivällisyyttä...
_P;
...
sivut joita EI indeksoida
_P;

$tsep_lng['pages_to_be_indexed'] = <<<_P
sivut jotka indeksoidaan
_P;
...
Vinkkejä TSEPin tehokkaaseen käyttöön
_P;
...
Etsii tiedostoja...<br />Pyydäämme kärsivällisyyttä...
_P;
...
Websivujesi domain. Haluaisimme tallettaa sen tiedot ja mahdollisesti ottaa kuvakaappauksen toiminnassa olevista sivuistasi.<br /><br />Huomaa että jos valitset mitä tahansa muita kohtia, URL lähetetään sivuillemme. Tämä ei tarkoita että loggaamme sen. Jos asetat valinnaksi <b>EI</b>, emme talleta sitä tietokantaamme.
_P;

$tsep_lng['setup_NewsLetter'] = <<<_P
Rekisteröidy ja tilaa uutiskirjeemme:
_P;

$tsep_lng['setup_NewsLetter_Help'] = <<<_P
Jos haluat rekisteröityä saadaksesi uusimmat TSEP -uutiset, anna e-mail -osoitteesi tänne.<br /><br/>Jos et ole kiinnostunut, jätä kenttä tyhjäksi.<br /><br/>Jos haluat peruuttaa rekisteröitymisen, siirry websivuillemme. Tämä kenttä toimii vain rekisteröitymiseen.
_P;
...
JavaScript täytyy olla päällä jotta esikatselu toimii.
_P;

$tsep_lng['indexer_started_indexer'] = <<<_P
Indeksoija käynnistetty
_P;
...
Rakentaa indeksiä ( %d tiedostosta)
_P;
